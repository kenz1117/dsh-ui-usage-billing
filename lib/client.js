window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*  返回全新对象（含 targets 数组拷贝），避免调用方就地修改污染共享默认值。 */
		...
		const DEFAULT_BILLING_CARD_PREFS = { metric: "money" };
		/** localStorage key（与 budget store 的 `dsh.ui-usage-billing.*` 命名空间一致）。 */
		const BILLING_CARD_STORAGE_KEY = "dsh.ui-usage-billing.card";
		/** 读取计费卡偏好（含损坏/缺失回退到默认）。仅在浏览器半区调用。 */
		function loadBillingCardPrefs() {
			try {
				const raw = localStorage.getItem(BILLING_CARD_STORAGE_KEY);
				if (raw === null) return { ...DEFAULT_BILLING_CARD_PREFS };
				return { metric: JSON.parse(raw).metric === "tokens" ? "tokens" : "money" };
			} catch {
				return { ...DEFAULT_BILLING_CARD_PREFS };
			}
		}
		/** 写入计费卡偏好。失败静默（展示偏好非关键）。 */
		function saveBillingCardPrefs(prefs) {
			try {
		...
		var UsageBilling_module_css_default = {
			...
			"peakCountPrimary": "VWh0dG_peakCountPrimary",
			"roundsBarWrap": "VWh0dG_roundsBarWrap",
			"peakCount": "VWh0dG_peakCount",
			"vendorLogo": "VWh0dG_vendorLogo",
			"heatmapYearCell": "VWh0dG_heatmapYearCell",
			"heatmapRangeButtonActive": "VWh0dG_heatmapRangeButtonActive",
			"heatmapYear": "VWh0dG_heatmapYear",
			...
			"heroBudgetFill": "VWh0dG_heroBudgetFill",
			"rowlineName": "VWh0dG_rowlineName",
			"closeButton": "VWh0dG_closeButton",
			"tabPanelIn": "VWh0dG_tabPanelIn",
			"rangeToggle": "VWh0dG_rangeToggle",
			"heatmap": "VWh0dG_heatmap",
			"ubCardSub": "VWh0dG_ubCardSub",
			"popModelStatus": "VWh0dG_popModelStatus",
			...
			"setCardDesc": "VWh0dG_setCardDesc",
			"ctlRowStretch": "VWh0dG_ctlRowStretch",
			"tabPanel": "VWh0dG_tabPanel",
			"triggerPopBadgeSub": "VWh0dG_triggerPopBadgeSub",
			"ubChipOff": "VWh0dG_ubChipOff",
			...
			"floatSubHead": "VWh0dG_floatSubHead",
			"ubPricepair": "VWh0dG_ubPricepair",
			"heroLabel": "VWh0dG_heroLabel",
			"pricingToggle": "VWh0dG_pricingToggle",
			"budgetHint": "VWh0dG_budgetHint",
			"ubRate": "VWh0dG_ubRate",
			"triggerPopSwitchBtn": "VWh0dG_triggerPopSwitchBtn",
			...
			"floatModeBtn": "VWh0dG_floatModeBtn",
			"kpiGreen": "VWh0dG_kpiGreen",
			"shareSegOff": "VWh0dG_shareSegOff",
			"triggerMetric": "VWh0dG_triggerMetric",
			"popModelStatusLow": "VWh0dG_popModelStatusLow",
			"ubChipPeak": "VWh0dG_ubChipPeak",
			"reconcileDismiss": "VWh0dG_reconcileDismiss",
			"triggerPopStrong": "VWh0dG_triggerPopStrong",
			"healthDot": "VWh0dG_healthDot",
			"triggerPopSwitchCount": "VWh0dG_triggerPopSwitchCount",
			...
			"heatmapYearMonths": "VWh0dG_heatmapYearMonths",
			"subscriptionFill": "VWh0dG_subscriptionFill",
			"ctlRow": "VWh0dG_ctlRow",
			...
			"popModel": "VWh0dG_popModel",
			"triggerPopFootStrong": "VWh0dG_triggerPopFootStrong",
			"setCardTitle": "VWh0dG_setCardTitle",
			"dashboardIn": "VWh0dG_dashboardIn",
			"ubNotesDesc": "VWh0dG_ubNotesDesc",
			"heatmapCell": "VWh0dG_heatmapCell",
			"floatTargets": "VWh0dG_floatTargets",
			"heroMeta": "VWh0dG_heroMeta",
			"popTitle": "VWh0dG_popTitle",
			"heroGaugeCenter": "VWh0dG_heroGaugeCenter",
			"pricingTable": "VWh0dG_pricingTable",
			"plgNameRow": "VWh0dG_plgNameRow",
			"peakCardCorner": "VWh0dG_peakCardCorner",
			"peakTag": "VWh0dG_peakTag",
			"plgHead": "VWh0dG_plgHead",
			"ubStatCard": "VWh0dG_ubStatCard",
			"ubChipLabel": "VWh0dG_ubChipLabel",
			...
			"ubTablewrap": "VWh0dG_ubTablewrap",
			"roundsBarLabel": "VWh0dG_roundsBarLabel",
			"peakCardOff": "VWh0dG_peakCardOff",
			"ubExtraRow": "VWh0dG_ubExtraRow",
			"roundsBarFlagged": "VWh0dG_roundsBarFlagged",
			"ubNotes": "VWh0dG_ubNotes",
			"ubTagPromo": "VWh0dG_ubTagPromo",
			...
			"popModelRow": "VWh0dG_popModelRow",
			...
			"hero": "VWh0dG_hero",
			"heatmapYearWeekday": "VWh0dG_heatmapYearWeekday",
			...
			"triggerYen": "VWh0dG_triggerYen",
			"heatmapRangeButton": "VWh0dG_heatmapRangeButton",
			...
			"triggerPopSubscription": "VWh0dG_triggerPopSubscription",
			"ctlCol": "VWh0dG_ctlCol",
			...
			"feeSep": "VWh0dG_feeSep",
			"dashboardSubtitle": "VWh0dG_dashboardSubtitle",
			"budgetInput": "VWh0dG_budgetInput",
			"ubCard": "VWh0dG_ubCard",
			"peakCountSuccess": "VWh0dG_peakCountSuccess",
			...
			"plgName": "VWh0dG_plgName",
			"setCard": "VWh0dG_setCard",
			...
			"rowlineDrillWrap": "VWh0dG_rowlineDrillWrap",
			"feeSuffix": "VWh0dG_feeSuffix",
			...
			"popModelName": "VWh0dG_popModelName",
			"setCardMeta": "VWh0dG_setCardMeta",
			"rowlineChev": "VWh0dG_rowlineChev",
			"progFill": "VWh0dG_progFill",
			"kpiGrid": "VWh0dG_kpiGrid",
			"budgetTrack": "VWh0dG_budgetTrack",
			"chartLine": "VWh0dG_chartLine",
			"heatmapRangeSwitch": "VWh0dG_heatmapRangeSwitch",
			"chartTooltipSwatch": "VWh0dG_chartTooltipSwatch",
			"popDotSub": "VWh0dG_popDotSub",
			"subscriptionMeta": "VWh0dG_subscriptionMeta",
			"tokenPanel": "VWh0dG_tokenPanel",
			"rateBadge": "VWh0dG_rateBadge",
			"peakHead": "VWh0dG_peakHead",
			"feeItem": "VWh0dG_feeItem",
			"peakDot": "VWh0dG_peakDot",
			"roundsBarCol": "VWh0dG_roundsBarCol",
			"floatSub": "VWh0dG_floatSub",
			"triggerSub": "VWh0dG_triggerSub",
			"heatmapFooter": "VWh0dG_heatmapFooter",
			"deltaUp": "VWh0dG_deltaUp",
			"floatSubPlan": "VWh0dG_floatSubPlan",
			"triggerPopLabel": "VWh0dG_triggerPopLabel",
			"ubExtraName": "VWh0dG_ubExtraName",
			"ubCardHead": "VWh0dG_ubCardHead",
			"feeNum": "VWh0dG_feeNum",
			...
			"ubStatGrid": "VWh0dG_ubStatGrid",
			"staleNotice": "VWh0dG_staleNotice",
			"subscriptionFillOver": "VWh0dG_subscriptionFillOver",
			"chartLegendBar": "VWh0dG_chartLegendBar",
			"ubStatValue": "VWh0dG_ubStatValue",
			"siteRowCallsLow": "VWh0dG_siteRowCallsLow",
			"ubTable": "VWh0dG_ubTable",
			"ctlGroup": "VWh0dG_ctlGroup",
			"feeChipOff": "VWh0dG_feeChipOff",
			...
			"ubStatDetail": "VWh0dG_ubStatDetail",
			...
			"popTagSub": "VWh0dG_popTagSub",
			"feeBar": "VWh0dG_feeBar",
			...
			"vendorLetter": "VWh0dG_vendorLetter",
			"rowlineRight": "VWh0dG_rowlineRight",
			...
			"popDotDirect": "VWh0dG_popDotDirect",
			"balanceDetailGrid": "VWh0dG_balanceDetailGrid",
			"plgIcon": "VWh0dG_plgIcon",
			"peakCardCenter": "VWh0dG_peakCardCenter",
			"ctlLabel": "VWh0dG_ctlLabel",
			"bucketStatValue": "VWh0dG_bucketStatValue",
			"triggerPopBar": "VWh0dG_triggerPopBar",
			"floatSubName": "VWh0dG_floatSubName",
			"rdo": "VWh0dG_rdo",
			"balanceDaysBadgeLow": "VWh0dG_balanceDaysBadgeLow",
			"ubNotesTerm": "VWh0dG_ubNotesTerm",
			"chartLegendLine": "VWh0dG_chartLegendLine",
			"heatmapYearBody": "VWh0dG_heatmapYearBody",
			"triggerSpark": "VWh0dG_triggerSpark",
			"plgDesc": "VWh0dG_plgDesc",
			"reconcileIcon": "VWh0dG_reconcileIcon",
			"heatmapYearWeekdays": "VWh0dG_heatmapYearWeekdays",
			...
			"popDotNeutral": "VWh0dG_popDotNeutral",
			"plgTag": "VWh0dG_plgTag",
			"plgLink": "VWh0dG_plgLink",
			"inp": "VWh0dG_inp",
			"triggerPopFootStatus": "VWh0dG_triggerPopFootStatus",
			"ubTagNeutral": "VWh0dG_ubTagNeutral",
			"popTagPrimary": "VWh0dG_popTagPrimary",
			"bandPriceOff": "VWh0dG_bandPriceOff",
			"plgTitle": "VWh0dG_plgTitle",
		...
		*/
		function UsageBillingTrigger(props) {
			const { wide, t, onOpen, monthCost, todayCost, weekCost, days, vendorStatus, dash, floatPrefs, subscriptions, cardPrefs, monthTokens, todayTokens, weekTokens } = props;
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									children: tokenView ? t("billing.triggerMonthTokens") : t("billing.triggerMonth")
								}), tokenView ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: UsageBilling_module_css_default.triggerMetric,
									"data-testid": "billing-trigger-month-tokens",
									children: formatTokens(monthTokens)
								...
								children: tokenView ? `${t("billing.triggerToday")} ${formatTokens(todayTokens)} · ${t("billing.weekCost")} ${formatTokens(weekTokens)}` : `${t("billing.triggerToday")} ${formatMoney(todayCost)} · ${t("billing.weekCost")} ${formatMoney(weekCost)}`
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		...
		function BillingDashboard({ stats, t, onClose, health, balances, reconcile, quotas, relayQuotas, currency, onCurrency, turns, renderSlot, budgetEnabled, budgetAmount, onToggleBudget, onBudgetAmount, peakConfig, onPeakConfig, onPreviewPeak, floatPrefs, onFloatPrefs, cardPrefs, onCardPrefs, quotasStale }) {
							...
							children: [
								...
								tab === "settings" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
											className: UsageBilling_module_css_default.setCard,
											"data-testid": "billing-card-setting",
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: UsageBilling_module_css_default.setCardHead,
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													className: UsageBilling_module_css_default.setCardMeta,
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
														className: UsageBilling_module_css_default.setCardTitle,
														children: t("billing.cardDisplay")
													}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
														className: UsageBilling_module_css_default.setCardDesc,
														children: t("billing.cardDisplayHint")
													})]
												})
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: UsageBilling_module_css_default.ctlCol,
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: UsageBilling_module_css_default.ctlLabel,
														children: t("billing.cardMetric")
													}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
														className: UsageBilling_module_css_default.ctlGroup,
														"data-testid": "billing-card-metric",
														children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
															type: "button",
															className: clsx(UsageBilling_module_css_default.floatModeBtn, cardPrefs.metric === "money" && UsageBilling_module_css_default.floatModeBtnOn),
															"data-testid": "billing-card-money",
															onClick: () => onCardPrefs({ metric: "money" }),
															children: t("billing.cardMetricMoney")
														}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
															type: "button",
															className: clsx(UsageBilling_module_css_default.floatModeBtn, cardPrefs.metric === "tokens" && UsageBilling_module_css_default.floatModeBtnOn),
															"data-testid": "billing-card-tokens",
															onClick: () => onCardPrefs({ metric: "tokens" }),
															children: t("billing.cardMetricTokens")
														})]
													})]
												})
											})]
		...
		*/
		function UsageBilling(props) {
			...
			const [cardPrefs, setCardPrefs] = (0, react.useState)(() => loadBillingCardPrefs());
			const updateCardPrefs = (0, react.useCallback)((next) => {
				setCardPrefs(next);
			...
			const last7 = (0, react.useMemo)(() => lastSevenDays(stats.byDay).map((day) => {
				const row = stats.byDay[day.date];
				return {
					date: day.date,
					cost: day.cost,
					tokens: row === void 0 ? 0 : row.input + row.output
				};
			}), [stats.byDay]);
			const monthTokens = Object.entries(stats.byDay).filter(([date]) => date.startsWith(today.slice(0, 7))).reduce((sum, [, day]) => sum + day.input + day.output, 0);
			const todayTokens = (() => {
				const row = stats.byDay[today];
				return row === void 0 ? 0 : row.input + row.output;
			})();
