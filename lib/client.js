	...
	factory: (require) => {
		...
		function UsageBillingTrigger(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [currentSub !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SubscriptionCardView, {
						quota: currentSub,
						t,
						money
					}), targetSubs.length > 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: UsageBilling_module_css_default.triggerPopSwitcher,
						"data-testid": "billing-float-switcher",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: UsageBilling_module_css_default.triggerPopSwitchBtn,
		...
		*/
		...
		function BillingDashboard({ stats, t, onClose, health, balances, quotas, relayQuotas, currency, onCurrency, turns, renderSlot, budgetEnabled, budgetAmount, onToggleBudget, onBudgetAmount, peakConfig, onPeakConfig, onPreviewPeak, floatPrefs, onFloatPrefs }) {
			...
			const subscriptionOptions = (0, react.useMemo)(() => {
				const map = /* @__PURE__ */ new Map();
