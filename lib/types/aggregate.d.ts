 ...
 * v6 = fork 种子边界改用持久化 `SessionHeader.seedLength`（5 及更早扫描最后一个
 ...
 * 10：官方把 V4 Pro 路由时点从 09-10 12:00 推迟到 09-14 12:00（价目页注释 (2)），
 * pro 的回算分界改用 PRO_OFFLINE_MS——09-10 ~ 09-14 之间 V4 Pro 请求仍按 V4 Pro
 * 刊例计费（v8 行按 Flash 价折算，低估）；bump 全量重折。同时收录官方新规范名
