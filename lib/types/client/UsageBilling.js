...
function SubscriptionCardView({ quota, t, money }) {
    ...
    return (_jsxs("div", { className: css.subscriptionCard, "data-testid": "billing-subscription-card", children: [_jsxs("div", { className: css.subscriptionHead, children: [_jsx("span", { className: css.subscriptionName, children: quota.displayName }), quota.planType === 'code' && (() => {
...
function UsageBillingTrigger(props) {
    const { wide, t, onOpen, monthCost, todayCost, weekCost, days, vendorStatus, dash, floatPrefs, subscriptions, money, } = props;
    ...
    return (_jsxs("span", { className: css.triggerWrap, children: [_jsxs("button", { type: "button", className: css.trigger, "data-testid": "billing-trigger", onClick: onOpen, title: `${t('billing.title')} · ${formatMoney(monthCost)}`, children: [_jsx("span", { className: css.triggerIcon, "data-testid": "billing-trigger-icon", children: cardIcon }), _jsxs("span", { className: css.triggerBody, children: [_jsxs("span", { className: css.triggerRow, children: [_jsx("span", { className: css.triggerMeta, children: t('billing.triggerMonth') }), _jsx("span", { className: css.triggerAmount, children: formatMoney(monthCost) })] }), _jsxs("span", { className: css.triggerSub, "data-testid": "billing-trigger-today", children: [t('billing.triggerToday'), " ", formatMoney(todayCost), " \u00B7 ", weekCost > 0 ? `${t('billing.weekCost')} ${formatMoney(weekCost)}` : ''] })] }), _jsx("span", { className: css.triggerSpark, "data-testid": "billing-trigger-spark", "aria-hidden": "true", children: sparkHeights.map((h, index) => (_jsx("span", { className: index === sparkHeights.length - 1 ? css.triggerSparkHot : css.triggerSparkBar, style: { height: `${h}px` } }, days[index]?.date ?? String(index)))) })] }), _jsx("span", { className: clsx(css.triggerPop, floatPrefs.mode === 'subscription' && css.triggerPopSubscription), "data-testid": "billing-trigger-pop", "aria-hidden": "true", children: floatPrefs.mode === 'subscription' ? (_jsx(_Fragment, { children: targetSubs.length === 0 ? (_jsx("span", { className: css.triggerPopEmpty, children: t('billing.floatNoTargets') })) : (_jsxs(_Fragment, { children: [currentSub !== undefined && _jsx(SubscriptionCardView, { quota: currentSub, t: t, money: money }), targetSubs.length > 1 && (_jsxs("span", { className: css.triggerPopSwitcher, "data-testid": "billing-float-switcher", children: [_jsx("button", { type: "button", className: css.triggerPopSwitchBtn, "data-testid": "billing-float-prev", onClick: () => stepSub(-1), "aria-label": t('billing.floatPrev'), children: "\u2039" }), _jsxs("span", { className: css.triggerPopSwitchCount, children: [effectiveSubIndex + 1, "/", targetSubs.length] }), _jsx("button", { type: "button", className: css.triggerPopSwitchBtn, "data-testid": "billing-float-next", onClick: () => stepSub(1), "aria-label": t('billing.floatNext'), children: "\u203A" })] }))] })) })) : (_jsxs(_Fragment, { children: [_jsxs("span", { className: css.triggerPopMetrics, children: [_jsxs("span", { className: css.triggerPopMetric, children: [_jsx("span", { className: css.triggerPopMetricLabel, children: t('billing.monthCost') }), _jsx("span", { className: clsx(css.triggerPopMetricValue, css.triggerPopMetricHighlight), children: formatMoney(monthCost) })] }), _jsxs("span", { className: css.triggerPopMetric, children: [_jsx("span", { className: css.triggerPopMetricLabel, children: t('billing.tokenTotal') }), _jsx("span", { className: css.triggerPopMetricValue, children: formatTokens(dash.totalToken) })] }), _jsxs("span", { className: css.triggerPopMetric, children: [_jsx("span", { className: css.triggerPopMetricLabel, children: t('billing.input') }), _jsx("span", { className: css.triggerPopMetricValue, children: formatTokens(dash.input) })] }), _jsxs("span", { className: css.triggerPopMetric, children: [_jsx("span", { className: css.triggerPopMetricLabel, children: t('billing.output') }), _jsx("span", { className: css.triggerPopMetricValue, children: formatTokens(dash.output) })] }), _jsxs("span", { className: css.triggerPopMetric, children: [_jsx("span", { className: css.triggerPopMetricLabel, children: t('billing.cacheHit') }), _jsx("span", { className: css.triggerPopMetricValue, children: formatTokens(dash.cacheRead) })] }), _jsxs("span", { className: css.triggerPopMetric, children: [_jsx("span", { className: css.triggerPopMetricLabel, children: t('billing.calls') }), _jsx("span", { className: css.triggerPopMetricValue, children: dash.calls.toLocaleString() })] })] }), _jsxs("span", { className: css.triggerPopFoot, children: [_jsx("span", { className: css.triggerPopFootTitle, children: t('billing.popTodayModel') }), _jsxs("span", { className: css.triggerPopFootNotes, children: [vendorStatus.direct !== undefined && (_jsxs("span", { className: css.triggerPopFootNote, children: [_jsx("span", { className: clsx(css.triggerPopBadge, css.triggerPopBadgeDirect), children: t('billing.popDirectLead') }), _jsx("span", { className: css.triggerPopFootName, children: vendorStatus.direct.name }), _jsx("span", { className: clsx(css.triggerPopFootStatus, vendorStatus.direct.low && css.triggerPopFootStatusLow), children: vendorStatus.direct.text })] })), vendorStatus.sub !== undefined && (_jsxs("span", { className: css.triggerPopFootNote, children: [_jsx("span", { className: clsx(css.triggerPopBadge, css.triggerPopBadgeSub), children: t('billing.popSubLead') }), _jsx("span", { className: css.triggerPopFootName, children: vendorStatus.sub.name }), _jsx("span", { className: clsx(css.triggerPopFootStatus, vendorStatus.sub.low && css.triggerPopFootStatusLow), children: vendorStatus.sub.text })] })), vendorStatus.direct === undefined && vendorStatus.sub === undefined && (_jsx("span", { className: css.triggerPopFootNote, children: t('billing.popNoConsumption') }))] })] })] })) })] }));
}
/**
...
function BillingDashboard({ stats, t, onClose, health, balances, quotas, relayQuotas, currency, onCurrency, turns, renderSlot, budgetEnabled, budgetAmount, onToggleBudget, onBudgetAmount, peakConfig, onPeakConfig, onPreviewPeak, floatPrefs, onFloatPrefs, }) {
    ...
    const subscriptionOptions = useMemo(() => {
        const map = new Map();
        for (const id of Object.keys(SUBSCRIPTION_VENDORS))
            map.set(id, SUBSCRIPTION_VENDORS[id] ?? id);
        for (const quota of quotas)
            map.set(quota.provider, quota.displayName);
