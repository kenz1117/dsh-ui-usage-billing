...
function UsageBillingTrigger(props) {
    ...
    if (!wide) {
        return (_jsx("button", { type: "button", className: css.railButton, onClick: onOpen, title: formatMoney(monthCost), children: _jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "aria-hidden": "true", children: _jsx("path", { d: "M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" }) }) }));
    }
    return (_jsxs("button", { type: "button", className: css.trigger, onClick: onOpen, children: [_jsx("span", { className: css.triggerIcon, children: _jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "aria-hidden": "true", children: _jsx("path", { d: "M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" }) }) }), _jsxs("span", { className: css.triggerText, children: [_jsx("span", { className: css.triggerLabel, children: "\u8BA1\u8D39\u4EEA\u8868\u76D8" }), _jsxs("span", { className: css.triggerMeta, children: ["\u5F53\u6708 ", _jsx("strong", { children: formatMoney(monthCost) }), todayCost > 0 && _jsxs("em", { children: ["\u4ECA\u65E5 ", formatMoney(todayCost)] })] })] }), _jsx("svg", { className: css.triggerChevron, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "aria-hidden": "true", children: _jsx("path", { d: "m9 6 6 6-6 6" }) })] }));
}
/**
