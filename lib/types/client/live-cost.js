...
export function LiveCostBar({ useSession, t }) {
    ...
    return (_jsxs("span", { className: css.liveCostBar, "data-testid": "billing-live-cost-bar", children: [_jsxs("span", { className: tier.tier === 'peak' ? css.liveTierPeak : css.liveTierOff, "data-testid": "billing-live-tier", children: [tier.tier === 'peak' ? t('billing.tierPeak') : t('billing.tierOff'), ' · ', formatSwitchCountdown(tier.nextSwitchInMs), ' ', tier.tier === 'peak' ? t('billing.tierToOff') : t('billing.tierToPeak')] }), hasCost && (_jsxs(_Fragment, { children: [_jsx("span", { className: css.liveCostSep, "aria-hidden": "true", children: "\u00B7" }), _jsxs("span", { className: css.liveCostItem, "data-testid": "billing-live-turn", children: [t('billing.liveTurn'), " ", money(turnCost)] }), _jsx("span", { className: css.liveCostSep, "aria-hidden": "true", children: "\u00B7" }), _jsxs("span", { className: css.liveCostItem, "data-testid": "billing-live-session", children: [t('billing.liveSession'), " ", money(sessionCost)] })] })), chips.map(chip => (_jsxs("span", { children: [_jsx("span", { className: css.liveCostSep, "aria-hidden": "true", children: "\u00B7" }), _jsxs("span", { className: chip.pct <= 10 ? css.liveQuotaCrit : css.liveQuotaWarn, "data-testid": "billing-live-quota", children: [chip.name, " ", t(windowLabelKey(chip.kind)), " ", chip.pct, "%"] })] }, `${chip.name}:${chip.kind}`)))] }));
}
