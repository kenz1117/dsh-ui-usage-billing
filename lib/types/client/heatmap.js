 ...
 */
export function UsageHeatmap({ days, currency, now, t }) {
    ...
    return (_jsxs("div", { className: css.heatmap, children: [_jsx("div", { className: css.heatmapGrid, role: "img", "aria-label": "daily cost heatmap", children: weeks.map(week => week.map((cell) => {
                    if (cell.placeholder)
