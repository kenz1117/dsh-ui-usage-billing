...
export const DEFAULT_FLOAT_WINDOW_PREFS = { mode: 'combined', targets: [] };
...
export function loadFloatWindowPrefs() {
    try {
        ...
        return {
            ...
            targets: Array.isArray(parsed.targets)
                ? parsed.targets.filter((entry) => typeof entry === 'string')
                : [],
        };
    }
    catch {
...
/** 写入浮窗偏好。失败静默（展示偏好非关键）。 */
export function saveFloatWindowPrefs(prefs) {
    try {
...
//# sourceMappingURL=usage-billing-settings.js.map