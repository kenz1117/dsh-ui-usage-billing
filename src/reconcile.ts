 ...
 * @param nowMs - 当前时刻。
 */
function snapOf(ref: Pick<BalanceRef, 'date' | 'currency'>, balance: BalanceSnapshot, nowMs: number): BalanceRef {
  return {
    date: ref.date,
 ...
 */
export function reconcileBalanceDelta(
  prevRef: BalanceRef | null,
  balance: BalanceSnapshot,
  todayOfficialCost: number,
  dayKey: string,
  nowMs: number,
): { ref: BalanceRef | null; event: ReconcileEvent | null } {
